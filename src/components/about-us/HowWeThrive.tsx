...
const thriveData: ThriveItem[] = [
  ...
  { title: "Action Oriented", description: "We transform ideas into tangible results through decisive action.", icon: "rocket" },
  { title: "Continuous Growth", description: "We embrace learning and development as core principles.", icon: "trending-up" },
  { title: "Excellence Pursuit", description: "We strive for exceptional quality in everything we do.", icon: "star" },
  { title: "Shared Success", description: "We celebrate achievements and grow together as one team.", icon: "award" },
];
...
export default function HowWeThrive() {
  ...
  if (!mounted) {
    // You can render a spinner or nothing here to avoid flicker
    return null;
  }
      ...
      <div className="w-full max-w-screen-xl mx-auto px-4 sm:px-6 xl:px-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="w-full max-w-[700px] h-auto mx-auto">
            <div
              className={`relative w-full h-[450px] sm:h-[500px] lg:h-[560px] rounded-2xl overflow-hidden border shadow-md
                ${resolvedTheme === "dark"
            ...
            <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
              {thriveData.map(({ title, description, icon }) => {
                ...
                return (
                  <Card
                    key={title}
                    className={`shadow-md border-none backdrop-blur-sm transition-colors duration-500
